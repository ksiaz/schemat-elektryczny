...
export const SINGLE_LINE_ELEMENT_DEFINITIONS: ElementDefinition[] = [
  ...
  {
    id: 'sld_grid_inverter',
    name: 'Falownik sieciowy',
    category: 'sldInverter',
    designation: 'U',
    nodeType: 'sldGridInverter',
    defaultLabel: 'U1',
    parameters: [
      { key: 'power', label: 'Moc', type: 'number', unit: 'kW', defaultValue: 10 },
      { key: 'voltage', label: 'Napięcie', type: 'number', unit: 'V', defaultValue: 400 },
  ...
  },
  {
    ...
    category: 'sldInverter',
    designation: 'R',
    nodeType: 'sldResistor',
    defaultLabel: 'R1',
    parameters: [
      { key: 'resistance', label: 'Rezystancja', type: 'number', unit: 'Ω', defaultValue: 100 },
    ],
  },
  {
    id: 'sld_wind_turbine',
    ...
    category: 'sldInverter',
    designation: 'TW',
    nodeType: 'sldWindTurbine',
    defaultLabel: 'TW1',
    parameters: [
      { key: 'power', label: 'Moc', type: 'number', unit: 'kW', defaultValue: 5 },
      { key: 'voltage', label: 'Napięcie', type: 'number', unit: 'V', defaultValue: 400 },
      { key: 'model', label: 'Model', type: 'text' },
    ],
  },
