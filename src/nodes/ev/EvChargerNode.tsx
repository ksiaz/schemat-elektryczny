...
export function EvChargerNode({ data, selected }: NodeProps<EvChargerNodeType>) {
  return (
    <div className={`flex flex-col items-center ${selected ? 'ring-2 ring-blue-500 ring-offset-2' : ''}`}>
      ...
      {/* Wallbox — prostokat z symbolem wtyczki EV */}
      <svg width="50" height="50" viewBox="0 0 50 50">
        <rect x="5" y="5" width="40" height="40" fill="white" stroke="black" strokeWidth="1.5" rx="3" />
        {/* Wtyczka EV */}
        <circle cx="25" cy="20" r="6" fill="none" stroke="black" strokeWidth="1" />
        <line x1="25" y1="14" x2="25" y2="26" stroke="black" strokeWidth="1" />
        <line x1="19" y1="20" x2="31" y2="20" stroke="black" strokeWidth="1" />
        {/* EV */}
        <text x="25" y="38" textAnchor="middle" fontSize="8" fontWeight="bold">EV</text>
      </svg>
