...
export function InverterNode({ data, selected }: NodeProps<InverterNodeType>) {
  return (
    <div className={`flex flex-col items-center ${selected ? 'ring-2 ring-blue-500' : ''}`}>
      ...
      <Handle type="source" position={Position.Right} id="com" className="!w-1.5 !h-1.5" style={{ backgroundColor: "#999", top: "50%" }} />
      <Handle type="source" position={Position.Left} id="pe-housing" className="!w-1.5 !h-1.5" style={{ backgroundColor: "#228B22", top: "50%" }} />
