  ...
  return (
    <div className={`flex flex-col items-center ${selected ? 'ring-2 ring-blue-500' : ''}`} style={{ width: 30 }}>
      ...
      <svg width="30" height="30" viewBox="0 0 30 30" style={{ overflow: 'visible' }}>
        <text x="15" y="-4" textAnchor="middle" fontSize="9" fill={WIRE_COLORS.L1} fontWeight="bold">{data.label}</text>
        <rect x="5" y="5" width="20" height="20" fill="none" stroke={WIRE_COLORS.L1} strokeWidth="1.5" />
        <circle cx="15" cy="15" r="4" fill="none" stroke={WIRE_COLORS.L1} strokeWidth="1" />
        <line x1="12" y1="15" x2="18" y2="15" stroke={WIRE_COLORS.L1} strokeWidth="1" />
