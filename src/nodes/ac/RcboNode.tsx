  ...
  return (
    <div className={`flex flex-col items-center ${selected ? 'ring-2 ring-blue-500 ring-offset-2' : ''}`}>
      ...
      <svg width="44" height="85" viewBox="0 0 44 85">
        ...
        <rect x="26" y="18" width="5" height="4" fill="none" stroke="white" strokeWidth="1" />

        {/* Wyzwalacz elektromagnetyczny — polkole */}
        <path d="M 18,28 A 5,5 0 0,1 26,28" fill="none" stroke="white" strokeWidth="1" />

        {/* Styk dolny */}
        <circle cx="22" cy="30" r="2" fill="white" />

        {/* Prostokat wyzwalacza roznicowego */}
        <rect x="6" y="34" width="32" height="26" fill="none" stroke="white" strokeWidth="1.5" rx="1" />

        {/* Toroid */}
        <circle cx="22" cy="47" r="7" fill="none" stroke="white" strokeWidth="1" />
        <line x1="16" y1="40" x2="16" y2="54" stroke="white" strokeWidth="0.8" />
        <line x1="28" y1="40" x2="28" y2="54" stroke="white" strokeWidth="0.8" />

        {/* Linia wyjsciowa */}
        <line x1="22" y1="60" x2="22" y2="85" stroke="white" strokeWidth="1.5" />
      </svg>
