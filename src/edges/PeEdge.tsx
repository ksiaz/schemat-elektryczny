...
// Przewod PE / uziemienia — zolto-zielony (paski)
    ...
    <g>
      ...
      {label && (
        <g transform={`translate(${labelX}, ${labelY - 10})`}>
          ...
          <text textAnchor="middle" dominantBaseline="central" fontSize="8" fill="#228B22" fontFamily="monospace">{label}</text>
        </g>
      )}
